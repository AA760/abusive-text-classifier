...
model.add(Bidirectional(LSTM(128, dropout=0.2, activation="relu", return_sequences=True)))
model.add(Dropout(0.3))
model.add(Bidirectional(LSTM(128, dropout=0.2, activation="relu")))
model.add(Dropout(0.3))
...
model.fit(train_sentences, train_labels, epochs=2, batch_size = 64)
